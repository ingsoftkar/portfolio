...
export const AssistIcon = ({ className, ...rest }) => (
  <svg
  ...
  >
    <g id="SVGRepo_iconCarrier">
      <defs>
        <style>
          {
            ".a{fill:none;stroke:#000;strokeLinecap:round;strokeLinejoin:round}"
          }
        </style>
      </defs>
      <path
        d="M18.71 30.64a4.76 4.76 0 0 0 4.16 1.86h2.52a4.24 4.24 0 0 0 4.24-4.25h0A4.24 4.24 0 0 0 25.39 24h-2.78a4.24 4.24 0 0 1-4.24-4.25h0a4.24 4.24 0 0 1 4.24-4.25h2.52a4.76 4.76 0 0 1 4.16 1.86"
        className="a"
      />
      <circle cx={24} cy={24} r={17.55} className="a" />
      <path
        d="M20.43 6.81A9.75 9.75 0 0 0 6.62 20.16M27.57 41.19a9.75 9.75 0 0 0 13.62-13.62"
        className="a"
      />
    </g>
  </svg>
